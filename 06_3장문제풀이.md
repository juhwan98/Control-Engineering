...
$\Phi(s) = (s\mathbf{I}-/mathbf{A})^{-1}$를 다음과 같이 계산할 수 있다.    
...
$$
det = (s-1)((s-3)(s-10)-0)-(-1)((-4)(s-10)-0)+1((-4)(-1)-(s-3)(2))
$$

위 계산된 식을 이용하여 G(s)를 구하자.
...
$\therefore G(s) = \frac{-8+24}{s^3-14s^2+37s_20}$
